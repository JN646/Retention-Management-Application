...
?>
<head><title>Top Experience</title></head>
<body>
		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-11">
					...
					$sql = "SELECT * FROM users ORDER BY EXP DESC";
					// Push out data
						...
						if(mysqli_num_rows($result) > 0){
							echo "<table id='table_search' class='table table-bordered'>";
								echo "<tr>";
									...
									echo "<th class='text-center' onclick='sortTable(2)'>Experience</th>";
								echo "</tr>";
