<div class="col-md-1">
	...
	<ul class="nav flex-column">
		<li class="nav-item">
			<a class="nav-link" href="http://localhost/reten/jobs/index.php">List</a>
		</li>
	</ul>
	<h5>Inbox & Tasks</h5>
	<ul class="nav flex-column">
		<li class="nav-item">
			<a class="nav-link" href="http://localhost/reten/inbox/mail.php">Inbox</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" href="http://localhost/reten/inbox/todo.php">Todo</a>
		</li>
	</ul>
	<h5>Reports</h5>
	<ul class="nav flex-column">
